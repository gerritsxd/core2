---
format: html
subtitle: 'UCID: extBehaviour_79n2r0sz'
title: External regulation of behaviour
toc: true
---

## Definition

Behaviour is externally regulated when an activity is adopted to acquire an outcome that is separable from the activity itself. 
...
Instruments that measure the degree to which engagement in the target activity is externally regulated.
...
Expressions that demonstrate or imply that engagement in the target behaviour is externally regulated, using phrases such as "Because I am supposed to do it" and "Because it is something that I have to do".
